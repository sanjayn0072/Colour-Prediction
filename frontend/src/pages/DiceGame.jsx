    ...
    <div className="flex flex-col min-h-screen bg-transparent text-slate-800 font-sans pb-20 relative select-none">
      ...
      {!isGameActive && (
        <div className="fixed inset-0 z-50 bg-slate-950/45 backdrop-blur-[6px] flex flex-col items-center justify-center p-6 text-center font-sans animate-[fadeIn_0.3s_ease-out]">
          ...
          <div className="bg-white border border-slate-200/80 rounded-[2.5rem] p-8 max-w-sm w-full space-y-6 shadow-xl relative z-10">
            <div className="space-y-2">
              <h2 className="text-xl font-bold text-slate-800 tracking-tight">Game under maintenance</h2>
            ...
            <button
              ...
              className="w-full py-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white text-xs font-black rounded-2xl shadow-lg shadow-indigo-500/10 cursor-pointer transition-all active:scale-98 border-0 outline-none uppercase tracking-wider"
            >
              Back to Home
            </button>
          </div>
