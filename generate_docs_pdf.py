...
<body>
  ...
  <div class="section">
    ...
    <p>
      <strong>Slider Loss/Win Color Zones:</strong> The slider background track updates dynamically using a linear gradient showing loss areas in light red (`#fee2e2`) and winning ranges in light green (`#dcfce7`), divided cleanly at the target coordinate index.
    </p>
    <p>
